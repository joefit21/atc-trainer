export const articles = [
  {
    ...
    cta: 'ICAO Radio Lab lets you practice IFR clearance readbacks with a realistic controller voice and instant feedback on exactly what you got right and what you missed. Try it free at practice.flight-levels.com/demo.',
  },

  {
    ...
    cta: 'ICAO Radio Lab is built around this exact problem. Practice every type of ATC radio call — ground, tower, departure, en route — with a realistic controller voice and real-time feedback. Try it free at practice.flight-levels.com/demo.',
  },

  {
    ...
    cta: 'ICAO Radio Lab is designed for exactly this gap — building the repetition and automaticity that formal test prep doesn\'t cover. Practice real ATC scenarios with a native English controller voice until it feels natural. Try it free at practice.flight-levels.com/demo.',
  },

  {
    ...
    cta: 'ICAO Radio Lab scores your readbacks the way a real controller would — identifying exactly what you got right, what you missed, and what was garbled. Try it free at practice.flight-levels.com/demo.',
  },
]
